package com.anggit97.stfalcon_imageviewer;
...
import com.anggit97.stfalcon_imageviewer.listeners.OnDismissListener;
...
import com.anggit97.stfalcon_imageviewer.viewer.dialog.ImageViewerDialog;
...
public class StfalconImageViewer<T> {
    ...
    private static final String LOG_TAG = "StfalconImageViewer";

    private final BuilderData<T> builderData;
    private final ImageViewerDialog<T> dialog;

    private StfalconImageViewer(@NonNull Context context, @NonNull BuilderData<T> builderData) {
    ...
    public void show(boolean animate) {
        if (!builderData.getImages().isEmpty()) {
            ...
            Log.w(LOG_TAG, "Images list cannot be empty! Viewer ignored.");
        }
    }
